...
if [ "$#" -ne 2 ]; then
    ...
    echo "Usage : $0 [URI of MongoDB Atlas, AWS Document DB or Azure Cosmos DB] [Version to test, either 3.6, 4.2 or 4.4]"
    exit 1
fi
if [[ $2 != "3.6" ]] && [[ $2 != "4.2" ]] && [[ $2 != "4.4" ]]; then
    echo "Invalid version; must be 3.6, 4.2 or 4.4"
fi
...
if [[ $VERSION == "4.2" ]] || [[ $VERSION == "4.4" ]]; then
