    ...
    def execute_and_store_command(self, command):
        ...
        try:
            with contextlib.redirect_stdout(self.__class__.stdout_stream), \
                ...
                if command == 'availableQueryOptions':
                    # Simulate response as this command is not supported on Atlas.
                    result = {"availableQueryOptions": "not supported on Atlas"}
                elif command == 'buildInfo':
                    result = self.__class__.docdb_admin.command('buildInfo')
                ...
                elif command == 'getCmdLineOpts':
                    result = self.__class__.docdb_admin.command('getCmdLineOpts')
                elif command == 'getLog':
                    result = self.__class__.docdb_admin.command('getLog', 'global')
                elif command == 'hello':
                    result = self.__class__.docdb_admin.command('hello')
                elif command == 'hostInfo':
                    result = self.__class__.docdb_admin.command('hostInfo')
                    ...
                    result = self.__class__.docdb_admin.command('ping')
                ...
                elif command == 'whatsmyuri':
                    result = self.__class__.docdb_admin.command('whatsmyuri')
